...
$(function () {
	...
	function makeArena(two, scaleFactor, arenaThickness) {
		...
		// cubes!!!
		var cubeSize = 12;
		var cube1 = two.makeRectangle(two.width / 2, (168 - 28 - cubeSize * 2.5) * scaleFactor, cubeSize * scaleFactor, cubeSize * scaleFactor);
		var cube2 = cube1.clone();
		cube2.translation.set(two.width / 2 - cubeSize / 2 * scaleFactor, (168 - 28 - cubeSize * 1.5) * scaleFactor);
		var cube3 = cube1.clone();
		cube3.translation.set(two.width / 2 + cubeSize / 2 * scaleFactor, (168 - 28 - cubeSize * 1.5) * scaleFactor);
		var cube4 = cube1.clone();
		cube4.translation.set(two.width / 2 - cubeSize * scaleFactor, (168 - 28 - cubeSize * 0.5) * scaleFactor);
		var cube5 = cube1.clone();
		cube5.translation.set(two.width / 2, (168 - 28 - cubeSize * 0.5) * scaleFactor);
		var cube6 = cube1.clone();
		cube6.translation.set(two.width / 2 + cubeSize * scaleFactor, (168 - 28 - cubeSize * 0.5) * scaleFactor);
		var cube7 = cube1.clone();
		cube7.translation.set(two.width / 2 - 68 * scaleFactor, (168 + 28 + cubeSize * 0.5) * scaleFactor);
		var cube8 = cube1.clone();
		cube8.translation.set(two.width / 2 - 41 * scaleFactor, (168 + 28 + cubeSize * 0.5) * scaleFactor);
		var cube9 = cube1.clone();
		cube9.translation.set(two.width / 2 - 13 * scaleFactor, (168 + 28 + cubeSize * 0.5) * scaleFactor);
		var cube10 = cube1.clone();
		cube10.translation.set(two.width / 2 + 68 * scaleFactor, (168 + 28 + cubeSize * 0.5) * scaleFactor);
		var cube11 = cube1.clone();
		cube11.translation.set(two.width / 2 + 41 * scaleFactor, (168 + 28 + cubeSize * 0.5) * scaleFactor);
		var cube12 = cube1.clone();
		cube12.translation.set(two.width / 2 + 13 * scaleFactor, (168 + 28 + cubeSize * 0.5) * scaleFactor);
		...
		cube13.translation.set(two.width / 2, two.height - ((168 - 28 - cubeSize * 2.5) * scaleFactor));
		var cube14 = cube1.clone();
		cube14.translation.set(two.width / 2 - cubeSize / 2 * scaleFactor, two.height - ((168 - 28 - cubeSize * 1.5) * scaleFactor));
		var cube15 = cube1.clone();
		cube15.translation.set(two.width / 2 + cubeSize / 2 * scaleFactor, two.height - ((168 - 28 - cubeSize * 1.5) * scaleFactor));
		var cube16 = cube1.clone();
		cube16.translation.set(two.width / 2 - cubeSize * scaleFactor, two.height - ((168 - 28 - cubeSize * 0.5) * scaleFactor));
		var cube17 = cube1.clone();
		cube17.translation.set(two.width / 2, two.height - ((168 - 28 - cubeSize * 0.5) * scaleFactor));
		var cube18 = cube1.clone();
		cube18.translation.set(two.width / 2 + cubeSize * scaleFactor, two.height - ((168 - 28 - cubeSize * 0.5) * scaleFactor));
		var cube19 = cube1.clone();
		cube19.translation.set(two.width / 2 - 68 * scaleFactor, two.height - ((168 + 28 + cubeSize * 0.5) * scaleFactor));
		var cube20 = cube1.clone();
		cube20.translation.set(two.width / 2 - 41 * scaleFactor, two.height - ((168 + 28 + cubeSize * 0.5) * scaleFactor));
		var cube21 = cube1.clone();
		cube21.translation.set(two.width / 2 - 13 * scaleFactor, two.height - ((168 + 28 + cubeSize * 0.5) * scaleFactor));
		var cube22 = cube1.clone();
		cube22.translation.set(two.width / 2 + 68 * scaleFactor, two.height - ((168 + 28 + cubeSize * 0.5) * scaleFactor));
		var cube23 = cube1.clone();
		cube23.translation.set(two.width / 2 + 41 * scaleFactor, two.height - ((168 + 28 + cubeSize * 0.5) * scaleFactor));
		var cube24 = cube1.clone();
		cube24.translation.set(two.width / 2 + 13 * scaleFactor, two.height - ((168 + 28 + cubeSize * 0.5) * scaleFactor));
